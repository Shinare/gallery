...
<div class="container">
    ...
    <form id="fileupload" action="{{asset('/upload/server/php/index.php')}}" method="POST" enctype="multipart/form-data">
...
@section('end')
    ...
    <script src="{{asset('upload/js/cors/jquery.xdr-transport.js')}}"></script>
    <![endif]-->
@endsection